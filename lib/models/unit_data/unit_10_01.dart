...
final UnitModel unit10_1 = UnitModel(
  unitIndex: 42,
  unitName: "Maintaining Rapport During Presentations",
  introductionText: """
Dear all,
Welcome to the lesson 10.1! In this lesson, we’ll explore the importance of maintaining rapport during your presentations. While delivering information is essential, connecting with your audience ensures that your message is received clearly and remembered. A strong rapport helps create an engaging, interactive, and enjoyable experience for both the speaker and the audience.
Let’s take a look at what you’ll achieve by the end of this lesson.
By the end of this lesson, you will be able to:
1.	Define the concept of rapport and explain its role in effective presentations.
2.	Identify practical strategies for engaging your audience and building rapport.
3.	Use body language, tone of voice, and eye contact to connect with listeners.
""",

  preClassActivityDescription: """
Before we begin, watch this short video on audience engagement and rapport in presentations:
...
""",
  ...
  PreClassQuestion(
    ...
    options: [
      ...
      'd) It eliminates the need for preparation.',
    ],
  ...
  PreClassQuestion(
    ...
    options: [
      ...
      'c) Using relatable examples',
      'd) Asking rhetorical or interactive questions',
    ],
    correctOptionIndex: 1,
  ),
  ],
  ...
  quizQuestions: [
    QuizQuestion(
      ...
      options: [
        ...
        'c) Speak in a flat voice with no pauses.',
        'd) Avoid interacting with the audience.',
      ],
      correctOptionIndex: 1,
    ),
    QuizQuestion(
      ...
      options: [
        ...
        'd) Rushing through your presentation.',
      ],
    ...
    QuizQuestion(
      ...
      options: [
        ...
        'c) Ask a question or share an interesting example.',
