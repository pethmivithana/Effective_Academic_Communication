...
final UnitModel unit3_9 = UnitModel(
  unitIndex: 14,
  unitName: "Future Continuous Tense",
  introductionText: """
...
Before we begin, let’s engage in a fun and creative time-travel activity to get familiar with the future continuous tense.

Imagine that you have a time machine that can take you anywhere in the future. Write three diary entries describing what you will be doing at different points in time (e.g., next month, in 10 years, on your dream vacation).
  ...
  quizQuestions: [
    QuizQuestion(
      ...
      options: [
        ...
        'c) I will be working on my project at this time tomorrow.',
        'd) I will work on my project at this time tomorrow.',
      ],
    ...
    QuizQuestion(
      ...
      options: [
        ...
        'd) To talk about completed future actions.',
      ],
    ...
    QuizQuestion(
      ...
      options: [
        ...
        'c) She is watching TV at 8 PM.',
        'd) She will be watching TV at 8 PM.',
      ],
