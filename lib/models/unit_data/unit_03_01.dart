...
final UnitModel unit3_1 = UnitModel(
  unitIndex: 6,
  ...
  quizQuestions: [
    QuizQuestion(
      ...
      options: [
        ...
        'b) She plays tennis.',
        'c) She will play tennis.',
        'd) She is playing tennis.',
      ],
    ...
    QuizQuestion(
      ...
      options: [
        ...
        'c) They is studying right now.',
        'd) He plays football every weekend.',
      ],
    ...
    QuizQuestion(
      ...
      options: [
        ...
        'c) She don\'t read books.',
        'd) She no reads books.',
      ],
